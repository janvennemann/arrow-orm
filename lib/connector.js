...
var util = require('util'),
	...
	delegateMethods = ['create', 'save', 'update', 'upsert', 'findAndModify', 'findOne', 'findOneMany', 'findAll', 'find', 'query', 'delete', 'deleteAll', 'distinct', 'upsert', 'count', 'createMany', 'deleteMany'];
