...
var util = require('util'),
	...
	consoleLog = console.warn.bind(console);
...
Model.prototype.findOne = function () {
	...
	var log = connector.logger ? connector.logger.warn.bind(connector.logger) : consoleLog;

	log('Deprecation warning: findOne method falls back to findByID. This is discouraged and will be removed in upcoming major release.');
