...
function Model(name, definition, skipValidation) {
	...
	var ModelFields = ['name', 'fields', 'connector', 'metadata', 'mappings', 'actions', 'disabledActions', 'singular', 'plural', 'autogen', 'generated'];
...
var VALID_ACTIONS = ['read', 'write', 'create', 'upsert', 'findAll', 'findOne', 'findAndModify', 'count', 'query', 'distinct', 'update', 'delete', 'deleteAll'];
...
Model.prototype.createAPI = function createAPI() {
	...
	return {
		...
		actionGroup: 'write',
		method: 'POST',
		description: this.createDescription || this.description || 'Create a ' + this.singular,
...
Model.prototype.updateAPI = function updateAPI() {
	...
	return {
		...
		actionGroup: 'write',
		method: 'PUT',
		description: this.updateDescription || this.description || 'Update a specific ' + this.singular,
...
Model.prototype.deleteAPI = function deleteAPI() {
	return {
		...
		description: this.deleteDescription || this.description || 'Delete a specific ' + this.singular,
		parameters: {
			id: {
				description: 'The ' + this.singular + ' ID',
				optional: false,
...
Model.prototype.deleteAllAPI = function deleteAllAPI() {
	return {
		...
		method: 'DELETE',
		actionGroup: 'write',
		description: this.deleteAllDescription || this.description || 'Deletes all ' + this.plural,
...
Model.prototype.distinctAPI = function distinctAPI() {
	...
	result.description = this.distinctDescription || this.description || 'Find distinct ' + this.plural;
...
Model.prototype.findOneAPI = function findOneAPI() {
	return {
		...
		actionGroup: 'read',
		method: 'GET',
		description: this.findOneDescription || this.description || 'Find one ' + this.singular,
		beforeEvent: this.beforeFindOneEvent || this.beforeEvent,
		afterEvent: this.afterFindOneEvent || this.afterEvent,
		eventTransformer: this.findOneEventTransformer || this.eventTransformer,
		parameters: {
			id: {
				description: 'The ' + this.singular + ' ID',
				optional: false,
...
Model.prototype.findAndModifyAPI = function findAndModifyAPI() {
	...
	return {
		...
		description: this.findAndModifyDescription || this.description || 'Find and modify ' + this.plural,
		parameters: parameters,
		responses: {
			204: {
				description: 'The update succeeded.'
...
Model.prototype.findAllAPI = function findAllAPI() {
	return {
		...
		description: this.findAllDescription || this.description || 'Find all ' + this.plural,
		actionGroup: 'read',
		method: 'GET',
...
Model.prototype.countAPI = function countAPI() {
	...
	result.uiSort = 7;
	result.path = './count';
	result.description = this.countDescription || this.description || 'Count ' + this.plural;
	result.dependsOnAny = ['query'];
...
Model.prototype.upsertAPI = function upsertAPI() {
	...
	result.description = this.upsertDescription || this.description || 'Create or update a ' + this.singular;
...
Model.prototype.queryAPI = function queryAPI() {
	return {
		...
		path: './query',
		method: 'GET',
		description: this.queryDescription || this.description || 'Query ' + this.plural,
		actionGroup: 'read',
		parameters: {
			limit: {
				type: 'query',
