...
var VALID_ACTIONS = ['create','upsert','read','findAll','findOne','findAndUpdate','count','query','distinct','update','delete','deleteAll'];
...
var excludeMethods = ['getConnector','getMeta','setMeta','get','set','keys','instance','getModels','payloadKeys','translateKeysForPayload'];
...
Model.prototype.distinctAPI = function distinctAPI() {
	return {
		...
		eventTransformer: this.distinctEventTransformer || this.eventTransformer,
		parameters: {
			field: {
				type: 'query',
				optional: false,
