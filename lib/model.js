 ...
 * @return {Object}
 */
Model.prototype.findByIDAPI = function findOneAPI() {
	return {
		generated: true,
		uiSort: 4,
		path: './:id',
 ...
 */
Model.prototype.findByID = Model.prototype.findById = Model.prototype.findOne = function findByID(id, callback) {
	try {
		var next = callback,
			cache = this.cache;
