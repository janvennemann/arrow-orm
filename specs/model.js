...
describe('models',function(){
	...
	describe('#API', function() {
		...
		it('should create count', function(){
			...
			should(API.parameters.order).have.property('description','A dictionary of one or more fields specifying sorting of results. In general, you can sort based on any predefined field that you can query using the where operator, as well as on custom fields.');
			...
			should(API.parameters.sel).have.property('description','Selects which fields to return from the query. Others are excluded.');
			...
			should(API.parameters.unsel).have.property('description','Selects which fields to not return from the query. Others are included.');
